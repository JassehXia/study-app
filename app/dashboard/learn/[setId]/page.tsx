...
export default function LearnModePage() {
  ...
  /* ------------------------------
     Main Page (1 question, 4 answers 2x2)
  ------------------------------- */
  return (
    <main className="min-h-screen flex items-center justify-center p-6 bg-blue-50">
...
<div className="grid grid-cols-2 gap-6">
  {choices.map((choice, i) => {
    ...
    return (
      <Button
        key={i}
        className={`w-full h-32 break-words whitespace-normal text-left border border-gray-300 text-black 
